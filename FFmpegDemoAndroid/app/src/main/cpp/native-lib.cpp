...
Java_com_sample_ffmpegdemo_utils_FFUtils_urlProtocolInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_com_sample_ffmpegdemo_utils_FFUtils_avFormatInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_sample_ffmpegdemo_utils_FFUtils_avCodecInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_sample_ffmpegdemo_utils_FFUtils_avFilterInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
Java_com_sample_ffmpegdemo_utils_FFUtils_playVideo(JNIEnv *env, jclass type, jstring videoPath_,
                                                   jobject surface) {
